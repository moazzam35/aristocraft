...
async function main() {
  ...
  const products: {
    ...
    { name: "Brown Classic Sofa", description: "A timeless brown sofa with plush cushioning, perfect for cozy family rooms. Its classic design complements both traditional and contemporary interiors.", price: 749.99, salePrice: 689.99, stock: 15, categoryId: sofa.id, imageUrl: "/images/sofa/brown.jfif", color: "Brown", colorHex: "#6B4226", material: "Polyester upholstery, plywood frame", dimensions: '210 x 85 x 82 cm', weight: 38, details: "Durable polyester-cotton blend fabric\nKiln-dried plywood frame\nPocket coil seating with foam wrap\nSide pockets for remote and magazines\nEasy assembly required", brand: "Aristocraft", sku: "SOF-BRN-003" },
    { name: "Brown Fabric Sofa", description: "A warm brown fabric sofa offering exceptional comfort and everyday durability. Ideal for high-traffic family rooms.", price: 799.99, salePrice: 703.99, stock: 12, categoryId: sofa.id, imageUrl: "/images/sofa/brown_sofa.jfif", color: "Brown", colorHex: "#8B6914", material: "Linen-blend fabric, hardwood frame", dimensions: '215 x 92 x 86 cm', weight: 42, details: "Linen-blend fabric with stain-resistant finish\nKiln-dried hardwood frame\nRemovable seat cushions with high-resiliency foam\nReversible seat cushions for even wear\nReinforced corner blocking", brand: "Aristocraft", sku: "SOF-BRN2-004" },
    ...
    { name: "Cream Linen Sofa", description: "An elegant cream linen sofa with clean lines for a bright and airy aesthetic that instantly lifts any room.", price: 1149.99, salePrice: null, stock: 6, categoryId: sofa.id, isFeatured: true, imageUrl: "/images/sofa/liner sofa cream.jfif", color: "Cream", colorHex: "#F5F0E1", material: "Belgian linen, hardwood frame", dimensions: '235 x 98 x 90 cm', weight: 52, details: "Premium Belgian linen upholstery\nHardwood frame with dowelled joints\nDown-blend seat cushion filling\nRemovable back and seat cushions\nCustom order fabric options available", brand: "Aristocraft", sku: "SOF-CRM-006" },
    ...
    { name: "Yellow Accent Chair", description: "A vibrant yellow accent chair that adds a playful and energetic touch to your decor. Fun and functional.", price: 289.99, salePrice: 260.99, stock: 14, categoryId: chair.id, imageUrl: "/images/chairs/yellow_chair.jfif", color: "Yellow", colorHex: "#F4C542", material: "Cotton blend, hardwood frame", dimensions: '72 x 68 x 84 cm', weight: 13, details: "Sunny yellow cotton-blend upholstery\nHardwood frame with lifetime warranty\nTufted backrest with button details\nSplayed wood legs in dark espresso\nNon-slip rubber feet pads", brand: "Aristocraft", sku: "CHR-YEL-007" },

    // === BEDS (10 products) ===
    { name: "Warby Bouclé Bed", description: "A luxurious sculptural bed with rounded edges and tufted terracotta bouclé texture.", price: 1899.99, salePrice: 1709.99, stock: 5, categoryId: bed.id, isFeatured: true, imageUrl: "/images/bed/bed(34).jfif", material: "Bouclé fabric, engineered wood frame", dimensions: '210 x 190 x 130 cm', weight: 75, details: "Sculptural rounded silhouette\nTextured terracotta bouclé upholstery\nPadded headboard with vertical tufting\nSolid slat support system\nBox spring not required", brand: "Aristocraft", sku: "BED-WRB-001" },
    { name: "Cozy Aesthetic Bed", description: "A cozy and stylish bed frame designed to create a warm, inviting bedroom sanctuary.", price: 1299.99, salePrice: 1234.99, stock: 8, categoryId: bed.id, imageUrl: "/images/bed/Cozy Bed Aesthetic.jfif", color: "Beige", colorHex: "#D4C5B0", material: "Linen upholstery, solid wood frame", dimensions: '200 x 180 x 120 cm', weight: 60, details: "Upholstered headboard with button tufting\nSolid pine wood frame with center support\nEasy assembly with pre-drilled holes\nAvailable in multiple fabric colors\nWooden slats included", brand: "Aristocraft", sku: "BED-COZ-002" },
